...
from agent_build.package_build_steps import IMAGE_BUILDS, StepsRunner, ImageBuild, _PROD_DOCKER_IMAGES_PLATFORMS
        ...
        def _test_pushed_image():
            ...
            for full_image_name in all_image_names_to_test:
                ...
                subprocess.check_call([
                    ...
                    "-f",
                    str(constants.SOURCE_ROOT / "agent_build" / "docker" / "Dockerfile.final-testing"),
                    "--build-arg",
            ...
            for plat in _PROD_DOCKER_IMAGES_PLATFORMS:
                logging.info(
